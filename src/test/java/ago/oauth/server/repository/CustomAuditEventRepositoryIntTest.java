package ago.oauth.server.repository;

import ago.oauth.server.Oauth2SqlServerApp;
import ago.oauth.server.config.Constants;
import ago.oauth.server.config.audit.AuditEventConverter;
import ago.oauth.server.domain.PersistentAuditEvent;
...
import static ago.oauth.server.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
