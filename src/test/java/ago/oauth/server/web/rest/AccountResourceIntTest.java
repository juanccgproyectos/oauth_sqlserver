package ago.oauth.server.web.rest;

import ago.oauth.server.config.Constants;
import ago.oauth.server.Oauth2SqlServerApp;
import ago.oauth.server.domain.Authority;
import ago.oauth.server.domain.User;
import ago.oauth.server.repository.AuthorityRepository;
import ago.oauth.server.repository.UserRepository;
import ago.oauth.server.security.AuthoritiesConstants;
import ago.oauth.server.service.MailService;
import ago.oauth.server.service.dto.UserDTO;
import ago.oauth.server.web.rest.errors.ExceptionTranslator;
import ago.oauth.server.web.rest.vm.KeyAndPasswordVM;
import ago.oauth.server.web.rest.vm.ManagedUserVM;
import ago.oauth.server.service.UserService;
...
@SpringBootTest(classes = Oauth2SqlServerApp.class)
